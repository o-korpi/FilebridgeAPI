    ...
    authenticate("auth-jwt") {
        route("/files") {
            ...
            post {
                ...
                val uuid =
                    service.persistFile(fileUpload, userEmail)
                        ?: return@post call.respond(
                            HttpStatusCode.BadRequest, "Invalid or incomplete upload data.")
            ...
            get("/{fileId}") {
                ...
                } else call.respond(HttpStatusCode.Unauthorized, "Unauthorized access.")
            }
