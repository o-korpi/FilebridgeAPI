...
fun Application.configureSecurity() {
    ...
    val jwtAudience =
        environment.config.propertyOrNull("jwt.audience")?.getString() ?: "jwt-audience"
    val jwtDomain =
        environment.config.propertyOrNull("jwt.domain")?.getString() ?: "https://filebridge.eu/"
    ...
    if (jwtRealm == "") println("Missing JWT secret")
